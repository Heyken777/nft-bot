...
urlpatterns = [
    ...
    path('verification/terms/', views.verification_terms_view, name='verification_terms'),
    path('verification/apply/', views.verification_apply_view, name='verification_apply'),
    path('verification/my/', views.verification_requests_view, name='verification_requests'),
    path('api/verification/apply/', views.verification_apply_api, name='verification_apply'),
    path('api/verification/purchase/', views.verification_purchase_api, name='verification_purchase'),
    ...
    path('api/deal/<int:deal_id>/claim/', views.api_claim_deal, name='api_claim_deal'),
