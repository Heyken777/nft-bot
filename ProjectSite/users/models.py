...
class User(models.Model):
    ...
    is_premium = models.BooleanField(default=False, verbose_name='Premium (устар.)')
    premium_tier = models.TextField(default='free', verbose_name='Тариф (free/premium/platinum/vip)')
